...
3) You have checked the variables in ${PLAYBOOK_HOME}/group_vars/ambari.yml to check the version of the ambari server and mysql connector, as well as the version of the jdk and mysql server roles in ${PLAYBOOK_HOME}/roles/java or mysql/vars.
